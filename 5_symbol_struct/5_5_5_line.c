...
float length(Line p1) { return distance(p1.a, p1.b); }
int is_equalLine(Line p1, Line p2) { return is_equal(p1.a, p2.a) && is_equal(p1.b, p2.b); }
void printLine(Line p) {
...
void movePoint2(Point* p, int dx) { p->x += dx; }
...
int is_equal(Point p1, Point p2) { return p1.x == p2.x && p1.y == p2.y; }
